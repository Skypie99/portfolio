 ...
 * showcase strip's hrefs as `litHrefs` (the "five live on the open web"
 ...
 *
 * Six real links, six honest tab stops (the pitch's named price), 44px hit
...
const GROUP_LABEL = 'The six works, on the horizon';

/** Hand-set seats along the horizon — uneven on purpose (a valley, not a chart). */
const SEATS = ['9%', '24%', '38.5%', '55%', '70.5%', '86%'];
